...
export const setCurrentDir = (dir: any) => ({type: fileTypes.SET_CURRENT_DIR, payload: dir})
export const addFile = (file: any) => ({type: fileTypes.ADD_FILE, payload: file})
export const pushToStack = (dir: string) => ({type: fileTypes.PUSH_TO_STACK, payload: dir})
